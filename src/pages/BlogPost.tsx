...
const BlogPost = () => {
  ...
  return (
    <>
          ...
          <Card className="p-6 border-l-4 border-l-primary bg-secondary/20">
            <p className="text-lg text-center">
               Ce bon conseil vous est proposé par Mon p'tit Dépanneur, 
                ...
                ) : post.slug === 'detecter-fuite-eau-maison' ? (
                 <>
                    votre{' '}
                    <Link 
                      to="/plombier-lille"
      ...
      {/* Testimonials */}
      {isPacArticle && pacTestimonials?.length ? (
        // Témoignages spécifiques aux pompes à chaleur
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Découvrez les avis de nos clients sur nos installations de pompes à chaleur à Lille et dans la métropole.
              </p>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <Carousel className="w-full">
                <CarouselContent className="-ml-2 md:-ml-4">
                  {pacTestimonials.map((testimonial) => (
      ...
      ) : isLocksmithArticle && locksmithTestimonials?.length ? (
        // Témoignages spécifiques à la serrurerie
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Découvrez les avis de nos clients sur nos services de serrurerie à Lille et dans la métropole.
              </p>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <Carousel className="w-full">
                <CarouselContent className="-ml-2 md:-ml-4">
                  {locksmithTestimonials.map((testimonial) => (
                    <CarouselItem key={testimonial.id} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
                      <Card className="p-8 bg-white border border-gray-200 hover:shadow-lg transition-shadow h-full">
                        <div className="inline-block px-3 py-1 bg-primary/10 text-primary text-sm font-medium rounded-full mb-4">
                          Serrurerie
