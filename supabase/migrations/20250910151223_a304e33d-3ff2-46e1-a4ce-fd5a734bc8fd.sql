...
INSERT INTO blog_posts (slug, title, excerpt, content, category, image_url, meta_title, meta_description) VALUES (
...
👉 Vous avez un doute sur votre installation ou souhaitez installer un nouveau chauffe-eau ? Contactez Mon p''tit Dépanneur au 03 28 53 48 68.',
  ...
  'Chauffe-eau électrique (cumulus) : bien le comprendre et réduire sa consommation',
  'Découvrez comment fonctionne un cumulus (chauffe-eau électrique) et nos conseils pour économiser de l''énergie et réduire vos factures d''eau chaude.'
);
