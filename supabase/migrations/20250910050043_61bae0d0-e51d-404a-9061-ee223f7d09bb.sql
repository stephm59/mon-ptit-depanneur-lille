-- Mise à jour de l'article existant sur l'entretien chaudière
UPDATE blog_posts 
SET 
  title = 'Entretien annuel des chaudières : pourquoi c''est important et comment le planifier',
  excerpt = 'En France, l''entretien annuel de votre chaudière est obligatoire. Découvrez pourquoi c''est indispensable et comment bien l''organiser avec Mon p''tit Dépanneur.',
  content = '# Entretien annuel des chaudières : pourquoi c''est important et comment le planifier
...
Oui. Même neuve, une chaudière doit être contrôlée chaque année pour maintenir sa garantie et optimiser sa durée de vie.',
  cover_image_url = 'https://pub-ee5d8554679a4a23a82caac56686992a.r2.dev/entretien-chaudiere.webp',
  published = true,
  published_at = COALESCE(published_at, now()),
  service_id = (SELECT id FROM services WHERE slug = 'chauffage' LIMIT 1),
  updated_at = now()
WHERE slug = 'planifier-entretien-chaudiere';