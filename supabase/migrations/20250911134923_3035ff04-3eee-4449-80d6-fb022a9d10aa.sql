-- Update blog post content to add H2 headings
UPDATE blog_posts 
SET content = '## Pourquoi l''eau est-elle si calcaire à Lille et dans le Nord ?
...
WHERE slug = 'lutter-contre-calcaire-nord';