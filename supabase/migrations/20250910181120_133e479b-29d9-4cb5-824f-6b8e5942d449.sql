-- Mettre à jour le contenu de l'article avec des bullet points et un meilleur formatage
UPDATE blog_posts 
SET content = '# Remplacer sa chaudière avec MaPrimeRénov'' : conditions, montant et démarches
...
| **Revenus du ménage** | **Chaudière gaz condensation** | **Chaudière biomasse** | **Pompe à chaleur air/eau** |
|---|---|---|---|
...
updated_at = now()
WHERE slug = 'aides-remplacement-chaudiere-maprimerenov';