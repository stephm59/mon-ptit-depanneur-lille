...
INSERT INTO public.service_city_pages (
  service_id, city_id, meta_title, meta_description, h1, h2_intro, intro_description,
  cta_title, cta_subtitle, zones_text, published
) 
SELECT 
  s.id as service_id,
  c.id as city_id,
  ...
  'Pompe à chaleur Villeneuve-d''Ascq (installation, entretien, dépannage)' as h1,
