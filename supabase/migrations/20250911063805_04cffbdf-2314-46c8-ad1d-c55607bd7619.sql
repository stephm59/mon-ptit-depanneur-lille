-- Update the blog post with h1 and corrected signature
UPDATE blog_posts 
SET 
  title = 'Appellation « Professionnel du Gaz » : que garantit-elle ?',
  content = '## Pourquoi faire appel à un « Professionnel du Gaz » (PG) ?
...
Ce bon conseil vous est proposé par Mon P''tit Dépanneur, [chauffagiste à Lille](/chauffagiste-lille).'
