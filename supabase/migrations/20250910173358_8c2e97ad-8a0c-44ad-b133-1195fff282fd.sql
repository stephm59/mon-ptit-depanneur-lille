-- Update blog post content to format advantages and disadvantages as bullet points
UPDATE public.blog_posts 
SET content = 'Besoin d''eau chaude au quotidien 💧 ? Entre chaudière, chauffe-eau électrique et chauffe-eau au gaz, il n''est pas toujours facile de s''y retrouver. Chaque système a ses avantages et ses limites.
...
WHERE slug = 'choisir-chaudiere-ou-chauffe-eau';