UPDATE blog_posts 
SET content = 'Savez-vous à quoi sert un raccord diélectrique ?
...
Ce bon conseil vous est proposé par Mon p''tit Dépanneur, [chauffagiste à Lille](/chauffagiste-lille).',
    title = 'Qu''est-ce qu''un raccord diélectrique et pourquoi est-il indispensable ?'
WHERE slug = 'raccord-dielectrique';